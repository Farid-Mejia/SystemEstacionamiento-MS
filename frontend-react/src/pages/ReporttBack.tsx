...
const Reports: React.FC = () => {
    ...
    try {
      ...
      if (filteredData.length > 0) {
        ...
        summaryData = {
          ...
          peakDay: peakDay ? format(new Date(peakDay.date), 'dd/MM/yyyy') : '',
  ...
  const exportToPDF = async () => {
    try {
      ...
      doc.text(`Día con más actividad: ${summary?.peakDay || ''}`, 20, summaryY + 30);
      doc.text(`Hora pico: ${summary?.peakHour || ''}`, 20, summaryY + 40);
